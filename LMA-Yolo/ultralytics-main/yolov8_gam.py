...
def get_params():
    params = {
        'weight': r'/root/plantdoc/yolov8n/weights/best.pt',
        'cfg': r'/root/autodl-tmp/ultralytics-main/ultralytics/cfg/models/v8/yolov8n.yaml',
        'device': 'cuda:0',
        'method': 'GradCAM', # GradCAMPlusPlus, GradCAM, XGradCAM
        'layer': 'model.model[13]',
...
if __name__ == '__main__':
    ...
    model(r'/root/autodl-tmp/heatmap/plantdoc/Image416_1.jpg','results1')